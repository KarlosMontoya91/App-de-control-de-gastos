...
const projectName = "saldo-mensual";
...
// NOTA: Usamos backticks escapados (\`) para que el archivo generado tenga los template literals correctos
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950 flex flex-col items-center justify-center animate-out fade-out duration-1000 delay-[1.5s] fill-mode-forwards pointer-events-none">
       <div className="flex flex-col items-center animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <h1 className="text-4xl font-bold text-white tracking-tighter">Saldo<span className="text-yellow-400">Mensual</span></h1>
...
console.log(`\n✅ Proyecto ${projectName} generado correctamente.`);
console.log(`👉 Ejecuta:`);
